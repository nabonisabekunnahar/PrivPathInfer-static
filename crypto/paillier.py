...
try:
    from gmpy2 import powmod as _gmpy_powmod
    GMPY2_AVAILABLE = True
    def _powmod(base, exponent, modulus):
        return int(_gmpy_powmod(base, exponent, modulus))
except ImportError:
...
def encrypt(m, public_key):
    ...
    # c = g^m * r^n mod n^2
    c = (_powmod(g, m, n2) * _powmod(r, n, n2)) % n2
